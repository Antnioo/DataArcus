...
window.clvTranslations = {
  en: {
    ...
    meta: {
      ...
      "og:image": "https://dataarcus.com/assets/img/og/clv.jpg",
      ...
      "twitter:image": "https://dataarcus.com/assets/img/og/clv.jpg",
  ...
  ar: {
    ...
    content: {
      ...
      p11: "تتبع القيمة الدائمة للعميل هو الفارق بين تمني النمو وهندسته بفعالية. إنه يحوّل بياناتك من سجل تاريخي إلى خارطة طريق تنبؤية للمستقبل.",
      p12: "إذا كنت مستعدًا للبدء في اتخاذ القرارات بناءً على أهم مقياس في عملك، فإن الخطوة الأولى هي محادثة.",
      p13: "<strong>احجز مكالمة وضوح بيانات مجانية وغير مُلزِمة معنا اليوم.</strong> سنناقش تحديات بيانات التجارة الإلكترونية الفريدة الخاصة بك ونوضح لك بالضبط ما هو ممكن ببياناتك الخاصة."
    },
