...
window.portfolioTranslations = {
  ...
  ar: {
    ...
    meta: {
      ...
      description: "استكشف مجموعة من لوحات تحكم Power BI المخصصة وحلول تحليل البيانات المبنية بواسطة DataArcus.",
      keywords: "مجموعة أعمال Power BI, دراسات حالة تحليل البيانات, أمثلة ذكاء الأعمال, لوحات تحكم المبيعات, تحليلات مركز الاتصال, مشاريع DataArcus"
    },
    
    // Page Header Arabic
    header: {
      title: "أعمالنا",
      subtitle: "نبني حلول بيانات مخصصة تحقق نتائج أعمال حقيقية. استكشف دراسات حالاتنا لترى كيف نحول البيانات المعقدة إلى أصول استراتيجية."
    },
    
    // Main Portfolio Section Arabic
    portfolio: {
      sectionTitle: "دراسات الحالة",
      sectionSubtitle: "كل مشروع هو شراكة. إليك نظرة على التحديات التي حللناها والقيمة التي قدمناها من خلال حلول Power BI المخصصة.",
      ...
      projects: {
        ...
        mavenmarket: {
          ...
          description: "تحليل متعمق لاتجاهات التجزئة، مساعداً أعمال التجارة الإلكترونية على تحديد المنتجات الأكثر مبيعاً وتحسين إنفاق التسويق بناءً على سلوك العملاء.",
          button: "عرض دراسة الحالة"
        },
        ...
        callcenter: {
          ...
          description: "مركز قيادة كامل لمراقبة مؤشرات الأداء الرئيسية لمركز الاتصال، وتتبع أداء الوكلاء، وتحسين رضا العملاء من خلال الرؤى المبنية على البيانات.",
          button: "عرض دراسة الحالة"
        },
        ...
        confidential: {
          ...
          description: "طورنا مركز تحكم مالي شامل لعميل خاص. توفر هذه اللوحة رؤى الربح والخسارة في الوقت الفعلي وتنبيهات التدفق النقدي تحت اتفاقية عدم إفشاء صارمة.",
          button: "طلب المعلومات"
        }
      }
    },
    ...
    heroProject: {
      badge: "مباشر وتفاعلي",
      title: "المشروع الرائد: مبيعات وعمليات AdventureWorks",
      featuresTitle: "الميزات الرئيسية والتقنيات المستخدمة:",
      tags: ["Power BI", "DAX المتقدم", "معاملات ماذا لو", "التحليل الجغرافي المكاني", "شجرة التفكيك"],
      button: "عرض دراسة الحالة الكاملة"
    },
    
    // Confidential Modal Arabic
    modal: {
      title: "معلومات المشروع السري",
      content: {
        paragraph1: "بسبب اتفاقية عدم الإفشاء (NDA)، تفاصيل هذا المشروع سرية. نحن نأخذ خصوصية العملاء على محمل الجد.",
        paragraph2: "ومع ذلك، يمكننا مناقشة كيف طبقنا تقنيات ومبادئ مماثلة لحل التحديات في القطاع المالي. يرجى الاتصال بنا لجدولة استشارة خاصة."
      },
