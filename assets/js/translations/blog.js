...
window.blogTranslations = {
  ...
  ar: {
    ...
    meta: {
      ...
      description: "أدلة عملية لقادة التجارة الإلكترونية في الشرق الأوسط حول Power BI ونمذجة البيانات واستراتيجية التحليلات. تعلم تتبع القيمة الدائمة للعميل وتحسين عائد التسويق والمزيد.",
      ...
      "og:description": "أدلة عملية لقادة التجارة الإلكترونية في الشرق الأوسط حول Power BI ونمذجة البيانات واستراتيجية التحليلات. تعلم تتبع القيمة الدائمة للعميل وتحسين عائد التسويق والمزيد.",
      "og:url": "https://dataarcus.com/blog.html",
      ...
      "twitter:description": "أدلة عملية لقادة التجارة الإلكترونية في الشرق الأوسط حول Power BI ونمذجة البيانات واستراتيجية التحليلات. تعلم تتبع القيمة الدائمة للعميل وتحسين عائد التسويق والمزيد.",
      "twitter:image": "https://dataarcus.com/assets/img/dataarcus-og-logo.png",
