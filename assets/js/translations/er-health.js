...
window.erHealthTranslations = {
  en: {
    ...
    meta: {
      ...
      "og:image": "https://dataarcus.com/assets/img/og/er-health.jpg",
      ...
      "twitter:image": "https://dataarcus.com/assets/img/og/er-health.jpg",
  ...
  ar: {
    ...
    meta: {
      ...
      keywords: "لوحة تحكم الطوارئ الصحية, تحليلات Power BI للرعاية الصحية, لوحة قسم الطوارئ, تحليلات تدفق المرضى, مؤشرات الرعاية الصحية, داتا أركوس",
      author: "داتا أركوس",
      "og:type": "website",
      "og:title": "مثال لوحة تحكم الطوارئ الصحية في Power BI - داتا أركوس",
      ...
      "og:locale": "ar_EG",
      "twitter:card": "summary_large_image",
      "twitter:title": "مثال لوحة تحكم الطوارئ الصحية في Power BI - داتا أركوس",
    ...
    features: {
      ...
      tags: ["Power BI", "DAX", "نمذجة البيانات", "تصميم واجهات", "مؤشرات الرعاية الصحية", "تحليل السلاسل الزمنية"],
      note: "هذا تقرير تفاعلي بالكامل من صفحتين. استخدم علامات التبويب في أعلى اليمين للتبديل بين عرض 'لوحة التحكم' و 'الملخص'."
    },
    ...
    finalCta: {
      ...
      subtitle: "حتى لو لم تكن في قطاع الرعاية الصحية، فإن هذه المبادئ تنطبق. احجز مكالمة وضوح بيانات مجانية مدتها 20 دقيقة لمناقشة بياناتك الخاصة.",
