...
window.erHealthTranslations = {
  ...
  ar: {
    // Page Meta Arabic
    meta: {
      title: "عرض لوحة التحكم: تحليل أداء غرفة الطوارئ - DataArcus",
      description: "لوحة تحكم تفاعلية في Power BI لتحليل زيارات غرفة الطوارئ. تتبع مؤشرات الأداء الرئيسية مثل أوقات الانتظار ورضا المرضى والتركيبة السكانية لتحسين الكفاءة التشغيلية.",
      keywords: "لوحة تحكم الرعاية الصحية, Power BI للرعاية الصحية, تحليلات الطوارئ, مؤشر أداء وقت انتظار المريض, لوحة تحكم أداء المستشفى, رضا المرضى"
    },
    
    // Page Header Arabic
    header: {
      title: "عرض لوحة التحكم: تحليل أداء غرفة الطوارئ",
      subtitle: "لوحة تحكم تفاعلية مصممة لتزويد مديري الرعاية الصحية برؤية واضحة لعمليات الطوارئ وتدفق المرضى."
    },
    
    // Case Study Introduction Arabic
    intro: {
      challenge: {
        title: "التحدي: إيجاد الوضوح في الفوضى",
        content: "غرف الطوارئ هي بيئات عالية الضغط تولد كميات هائلة من البيانات. التحدي هو تحويل هذه البيانات الخام إلى رؤى قابلة للتنفيذ يمكن أن تحسن رعاية المرضى وتبسط العمليات وتحسن تخصيص الموارد. يهدف هذا المشروع إلى بناء أداة لتحقيق ذلك."
      },
      skills: {
        title: "عرض المهارات",
        content: "تُعد لوحة التحكم هذه عرضًا عمليًا للتطوير الشامل في Power BI في سياق الرعاية الصحية، مع تسليط الضوء على الخبرة في:",
        list: [
          "<strong>تحليلات الرعاية الصحية:</strong> تطوير مؤشرات الأداء الرئيسية للمقاييس الحرجة مثل أوقات الانتظار والرضا وأداء الأقسام.",
          "<strong>نمذجة البيانات:</strong> هيكلة بيانات المرضى والزيارات المعقدة في نموذج متماسك وفعال.",
          "<strong>تحليل السلاسل الزمنية:</strong> تصور الاتجاهات بمرور الوقت لتحديد ساعات الذروة والأيام.",
          "<strong>واجهة المستخدم التنفيذية:</strong> إنشاء واجهة نظيفة وبديهية لأصحاب المصلحة غير التقنيين لاستكشاف البيانات السريرية."
        ]
      }
    },
    ...
    features: {
      ...
      tags: ["Power BI", "DAX", "نمذجة البيانات", "تصميم UX/UI", "مؤشرات أداء الرعاية الصحية", "تحليل السلاسل الزمنية"],
      note: "هذا تقرير تفاعلي بالكامل من صفحتين. استخدم علامات التبويب في أعلى اليمين للتبديل بين عرضي \"لوحة التحكم\" و \"الملخص\"."
    },
    
    // Capabilities Section Arabic
    capabilities: {
      title: "القدرات المعروضة",
      subtitle: "تحول لوحة التحكم هذه البيانات السريرية المعقدة إلى أداة قوية للإدارة التشغيلية، وتوفر رؤى واضحة حول:",
      list: [
        "<strong>مؤشرات الأداء الرئيسية بلمحة:</strong> توفر لوحة التحكم الرئيسية نظرة عامة في الوقت الفعلي على المقاييس الحرجة، بما في ذلك إجمالي عدد المرضى ومتوسط وقت الانتظار ومتوسط درجات الرضا، مع مؤشرات اتجاه لتتبع الأداء بمرور الوقت.",
        "<strong>الرؤى الديموغرافية:</strong> فهم السكان المرضى باستخدام مرشحات تفاعلية للفئة العمرية والجنس والعرق، مما يساعد على تحديد اتجاهات صحة المجتمع وضمان الرعاية العادلة.",
    ...
    finalCta: {
      ...
      subtitle: "تخيل أن يكون لديك هذا المستوى من الوضوح لعمليات عملك. دعنا نتحدث.",
      button: "ناقش مشروعك"
    }
  }
};
